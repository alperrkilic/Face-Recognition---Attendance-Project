...
imgElon = face_recognition.load_image_file('ImagesAttendance/Elon-musk.png')
imgElon = cv2.cvtColor(imgElon, cv2.COLOR_BGR2RGB)

imgTest = face_recognition.load_image_file('ImagesAttendance/Elon-test.png')
...
# gives value of true [True] , [0.44529542] (distance between faces)
